...
export function PosCheckoutModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl sm:rounded-3xl w-full max-w-lg shadow-2xl border border-slate-100 overflow-hidden flex flex-col my-auto max-h-[calc(100vh-5.5rem)]"
