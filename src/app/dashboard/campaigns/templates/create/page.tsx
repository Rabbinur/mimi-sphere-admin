...
import { useCreateTemplateMutation } from "@/components/Redux/RTK/campaignApi";
            ...
            <header className="mb-10 flex flex-col md:flex-row items-center gap-6 border-b pb-8">
                <div className="flex items-center gap-4 w-full">
                    ...
                    <div className="flex-grow">
                        <h1 className="text-3xl font-black text-gray-900 tracking-tight">Create Template</h1>
                        <p className="text-sm font-medium text-gray-500">Design a reusable email layout</p>
                    </div>
                </div>
            </header>
